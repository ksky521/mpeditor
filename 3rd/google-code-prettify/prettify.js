    ...
    (function () {
        function T(a) {
            function d(e) {
                ...
                let a = e.charAt(1);
                return (b = w[a]) ? b : '0' <= a && '7' >= a ? parseInt(e.substring(1),
                    8) : 'u' === a || 'x' === a ? parseInt(e.substring(2), 16) : e.charCodeAt(
                    1);
            }
            ...
            function b(e) {
                let b = e.substring(1, e.length - 1).match(
                ...
                for (var a = a ? 1 : 0, g = b.length; a < g; ++a) {
                    ...
                    if (/\\[bdsw]/i.test(h)) {
                        ...
                        e.push([h, k]);
                        65 > k || 122 < h || (65 > k || 90 < h || e.push([Math.max(65, h)
              | 32, Math.min(k, 90) | 32
                        ]), 97 > k || 122 < h || e.push([Math.max(97, h) & -33, Math.min(
                            k, 122) & -33]));
                    }
                }
                e.sort(function (e, a) {
                ...
                for (a = 0; a < e.length; ++a) {
                    h = e[a], h[0] <= g[1] + 1 ? g[1]
          = Math.max(g[1], h[1]) : b.push(g = h);
                }
                for (a = 0; a < b.length; ++a) {
                    h = b[a],
                    c.push(f(h[0])), h[1] > h[0] && (h[1] + 1 > h[0] && c.push('-'), c.push(
                        f(h[1])));
                }
                c.push(']');
                return c.join('');
            ...
            function v(e) {
                for (var a = e.source.match(
                    ...
                    ), c = a.length, d = [], g = 0, h = 0; g < c; ++g) {
                    var k = a[g];
                    '(' === k ? ++h : '\\' === k.charAt(0) && (k = +k.substring(1))
            && (k <= h ? d[k] = -1 : a[g] = f(k));
                }
                ...
                for (h = g = 0; g < c; ++g) {
                    k = a[g], '(' === k ? (++h, d[h] || (a[g]
            = '(?:')) : '\\'
          === k.charAt(0) && (k = +k.substring(1)) && k <= h && (a[g] = '\\' + d[
                        k]);
                }
                for (g = 0; g < c; ++g) {
                    '^' === a[g] && '^' !== a[g + 1] && (a[g]
          = '');
                ...
                if (e.ignoreCase && n) {
                    for (g = 0; g < c; ++g) {
                        k = a[g], e = k.charAt(0), 2 <= k.length
            && '[' === e ? a[g] = b(k) : '\\' !== e && (a[g] = k.replace(
                                /[a-zA-Z]/g,
                                function (a) {
                                    a = a.charCodeAt(0);
            ...
            function f(a) {
              ...
              << 1 | 1] = a;
                    ...
                    c = a.nodeValue, c.length && (c = d ? c.replace(
                        /\r\n?/g, '\n') : c.replace(/[ \t\r\n]+/g,
                        ' '), v[l] = c, n[l << 1] = A, A += c.length, n[l++ << 1 | 1]
          = a);
                }
            }
            var b = /(?:^|\s)nocode(?:\s|$)/;
        ...
        function V(a) {
            for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) {
                let b = f.nodeType;
                var d = 1 === b ? d ? a : f : 3 === b ? W.test(f.nodeValue) ? a : d : d;
            }
            return d === a ? void 0 : d;
        }
        ...
        function G(a, d) {
            function f(a) {
                for (var l = a.i, m = a.h, c = [l, 'pln'], p = 0, w = a.a.match(v) || [],
                    r = {}, e = 0, t = w.length; e
          < t; ++e) {
                    let z = w[e];
                    let q = r[z];
            ...
            let v;
            (function () {
                for (var f = a.concat(d), l = [], m = {}, c = 0, p = f.length; c
          < p; ++c) {
                    let w = f[c];
                    let r = w[3];
                    if (r) {
        ...
        function y(a) {
            ...
            b && (a.cStyleComments ? (1 < b ? d.push(['com',
                /^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/, null, '#'
            ]) : d.push(['com',
          ...
          + ('/(?=[^/*' + b + '])(?:[^/\\x5B\\x5C' + b + ']|\\x5C' + v
            ...
            b.length && f.push(['kwd', new RegExp('^(?:' + b.replace(/[\s,]+/g, '|')
        + ')\\b'), null]);
            d.push(['pln', /^\s+/, null, ' \r\n\t\u00a0']);
            b = '^.[^\\s\\w.$@\'"`/\\\\]*';
            a.regexLiterals && (b += '(?!s*/)');
            f.push(['lit', /^@[a-z_$][a-z_$@0-9]*/i, null], ['typ',
        ...
        function L(a, d, f) {
            function b(a) {
                ...
                if (1 == c && !A.test(a.className)) {
                    if ('br' === a.nodeName) {
                        v(a), a.parentNode && a.parentNode.removeChild(
                            a);
                    }
                    else {
                    ...
                    let d = a.nodeValue;
                    let q = d.match(n);
                    q && (c = d.substring(0, q.index), a.nodeValue = c, (d = d.substring(
                        q.index + q[0].length))
            ...
            function v(a) {
                ...
                a = b(a.nextSibling, 0);
                for (var d;
                    (d = a.parentNode) && 1 === d.nodeType;) {
                    a = d;
                }
                c.push(a);
            }
            for (var A = /(?:^|\s)nocode(?:\s|$)/, n = /\r\n?|\n/, l = a.ownerDocument,
                m = l.createElement('li'); a.firstChild;) {
            ...
            let w = l.createElement('ol');
            w.className = 'linenums';
            d = Math.max(0, d - 1 | 0) || 0;
            for (var p = 0, r = c.length; p < r; ++p) {
                m = c[p], m.className = 'L'
        + (p + d) % 10, m.firstChild || m.appendChild(l.createTextNode('\u00a0')),
                w.appendChild(m);
            }
            a.appendChild(w);
        }
        ...
        function t(a, d) {
            for (let f = d.length; 0 <= --f;) {
                let b = d[f];
                I.hasOwnProperty(b) ? E.console && console.warn(
                    'cannot override language handler %s', b) : I[b] = a;
            }
        }
        ...
        function M(a) {
            ...
            try {
                ...
                let r; let e;
                for (e = r = 0; e < p;) {
                    c[e] !== c[e + 2] ? (c[r++] = c[e++], c[r++]
          = c[e++]) : e += 2;
                }
                p = r;
                for (e = r = 0; e < p;) {
                    for (var t = c[e], z = c[e + 1], q = e + 2; q + 2 <= p && c[q + 1]
            === z;) {
                        q += 2;
                    }
                    c[r++] = t;
                ...
                try {
                    for (; b < m;) {
                        ...
                        if (1 !== B.nodeType && (D = A.substring(f, q))) {
                            v && (D = D.replace(d, '\r'));
                            B.nodeValue = D;
                            let N = B.ownerDocument;
                            let u = N.createElement('span');
                            u.className = c[w + 1];
                            let y = B.parentNode;
                            y.replaceChild(u, B);
                            u.appendChild(B);
                            f < h && (l[b + 1] = B = N.createTextNode(A.substring(q, h)), y
                                .insertBefore(B, u.nextSibling));
                        }
                        f = q;
                        f >= h && (b += 2);
                        f >= k && (w += 2);
      ...
      = /^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)\b/;
        ...
        let Y = E.PR = {
            ...
            prettyPrint: E.prettyPrint = function (a, d) {
                function f() {
                    for (let b = E.PR_SHOULD_USE_CONTINUATION ? c.now() + 250
                        : Infinity; p < t.length && c.now() < b; p++) {
                        for (var d = t[p], l = g, m = d; m = m.previousSibling;) {
                            var n = m.nodeType;
                            var u = (7 === n || 8 === n) && m.nodeValue;
                    ...
                    && u.className && r.test(u.className)) {
                            ...
                            if (!n) {
                                ...
                                if (!n) {
                                    var n = m.match(w);
                                    var C;
                                    !n && (C = V(d)) && z.test(C.tagName) && (n = C.className
                                        .match(w));
                                    n && (n = n[1]);
                                }
                                if (y.test(d.tagName)) {
                                    ...
                                    var x = v.defaultView;
                                    var u = (u = u ? u.whiteSpace : x && x.getComputedStyle
                                        ? x.getComputedStyle(d, null).getPropertyValue(
                                            'white-space') : 0) && 'pre' === u.substring(0, 3);
                                }
                                x = l.linenums;
                                (x = 'true' === x || +x) || (x = (x = m.match(
                                    /\blinenums\b(?::(\d+))?/)) ? x[1] && x[1].length ? +x[1] : !0 : !1);
                                x && L(d, x, u);
                                M({
                                    j: n,
                                    h: d,
                    ...
                    p < t.length ? E.setTimeout(f, 250) : 'function' === typeof a
              && a();
                }
                for (var b = d || document.body, v = b.ownerDocument || document,
                    b = [b.getElementsByTagName('pre'), b.getElementsByTagName(
                        'code'), b.getElementsByTagName('xmp')], t = [], n = 0; n
            < b.length; ++n) {
                    for (let l = 0, m = b[n].length; l < m; ++l) {
                        t.push(b[n][l]);
                    }
                }
                var b = null;
